...
- **Roles**: exactly six (SCM, Accounts, Finance, Admin, Warehouse, Logistics). (WAREHOUSE + LOGISTICS confirmed as real, distinct roles 2026-06-22 — Logistics = clearance/K1/BL/ETA, Warehouse = receiving; do NOT reduce or fold these into ADMIN.)
- **Currency**: MYR.
