                  ...
                  (() => {
                    ...
                    .map((p) => {
                      ...
                      return (
                        ...
                        >
                          {/* SKU is not shown — the variation name already identifies
                              the row. Full code stays on hover for reference. */}
                          <td
                            className="py-1.5 pl-10 pr-3 sticky left-0 z-10 bg-gray-50"
                            title={p.sku}
                          >
                            {p.variation || p.name}
                          </td>
