...
export default function AutoCountImportPage() {
  ...
  async function handleUpload() {
    ...
    try {
      const res = await fetch("/api/inventory/autocount-import", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Import AutoCount Sales (Offline)</h1>
          <p className="text-sm text-gray-500">
            Upload AutoCount &quot;Sold Unit Report&quot; for wholesale/offline channel
          </p>
        </div>
        <Link href="/inventory">
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-gray-600">
          <p>1. Export &quot;Sold Unit Report&quot; from AutoCount (any date range)</p>
          <p>2. Upload the Excel file below</p>
          <p>3. System will:</p>
          <ul className="list-disc ml-6 space-y-1">
            <li>Filter out cancelled invoices (Cancelled = &quot;T&quot;)</li>
            <li>Match products by Item Code or extract barcode from Detail Description</li>
            <li>Aggregate by product + month</li>
            <li>Write to Monthly Sales with channel = <b>AUTOCOUNT</b></li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label>AutoCount Sold Unit Report (.xlsx)</Label>
            <Input
              type="file"
              accept=".xlsx,.xls"
          ...
          {result && (
            <div className="bg-green-50 p-4 rounded-lg text-sm space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div>Missing item: {result.missingItem}</div>
              ...
              {result.unmatchedSkus?.length > 0 && (
                <div className="text-xs text-amber-600 mt-2">
                  <p className="font-medium">Unmatched SKUs:</p>
